...
<script src="https://cdn.jsdelivr.net/npm/alpinejs@2.x.x/dist/alpine.min.js" defer></script>
  ...
  <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
    ...
    <a @click="isOpen = !isOpen"  class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
        ...
        <span class="ml-2 text-sm tracking-wide truncate">{{ __('Crud Operation') }}</span>
        <div class="ml-1">
          <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
          </svg>
    ...
    <!-- Submenu for Hotels CRUD -->
    <ul x-show="isOpen" x-cloak class="pl-4">
        <li>
            <a :href="" :class="{ 'active': request()->routeIs('hotels.*') }" class="ml-8 text-sm tracking-wide truncate hover:bg-gray-50 text-gray-600 hover:text-gray-800">
                
            </a>
        </li>
        <!-- Add more hotel-related CRUD links as needed -->
    </ul>
    ...
    <ul x-show="isOpen" x-cloak class="pl-4">
    <li>
        <a :href="#" :class="{ 'active': request()->routeIs('rooms.*') }" class="ml-8 text-sm tracking-wide truncate hover:bg-gray-50 text-gray-600 hover:text-gray-800">
    ...
    <!-- Add more hotel-related CRUD links as needed -->
        ...
        <li>
          <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span class="ml-2 text-sm tracking-wide truncate">{{ __('Inbox') }}</span>
